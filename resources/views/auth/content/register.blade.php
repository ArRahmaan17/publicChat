...
@section('content')
    ...
    <body class="authentication-bg">
        <div id="preloader" class="w-100 h-100 d-flex bg-dark justify-content-center position-absolute p-0 m-0"
            style="z-index: 9999;">
            <div class="spinner-grow text-primary position-absolute top-50 start-50 translate-middle "
                style="width: 10rem; height: 10rem;" role="status"><span class="visually-hidden">Loading...</span>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center p-2">
                            <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-80">
                                <g clip-path="url(#clip0)" fill="#5b73e8">
                                    <path
                            ...
                            <div class="h2 text-primary">{{ env('APP_NAME') }}</div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <form action="{{ route('auth.registration') }}" method="POST">
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="text-muted mb-0">Already have an account ? <a
                                                    href="{{ route('auth.login') }}" class="fw-medium text-primary">
                                                    Login</a></p>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="mt-5 text-center">
                            <p>©
                                <script>
                                    ...
                                    class="mdi mdi-heart text-danger"></i> by Mannn17
                            </p>
                        </div>
