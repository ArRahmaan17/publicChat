...
@section('content')
    ...
    <body class="authentication-bg">
        <div id="preloader" class="w-100 h-100 d-flex justify-content-center position-absolute p-0 m-0">
        ...
        <div id="content" class="account-pages pt-sm-5">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <form action="{{ route('auth.authentication') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="phone_number" id="phone_number" placeholder="Enter phone">
                                        </div>
